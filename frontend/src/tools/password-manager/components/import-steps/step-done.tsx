		...
		<div className="p-8 flex flex-col items-center justify-center gap-6 text-center">
			...
			<div>
				<h2 className="text-2xl font-bold mb-2">
					{t("tools.password_manager.import.complete")}
				</h2>
				<p className="text-muted-foreground">
					{t("tools.password_manager.import.processed_total", {
						total,
					})}
				</p>
			</div>
			...
			<div className="bg-muted/50 rounded-xl p-6 w-full max-w-sm space-y-4">
				<div className="flex justify-between items-center text-sm">
					<span className="text-muted-foreground">
						{t(
							"tools.password_manager.import.successfully_imported",
						)}
					</span>
					<span className="font-semibold text-emerald-600">
						{imported} {t("tools.password_manager.import.items")}
					</span>
				</div>
				<div className="flex justify-between items-center text-sm">
					<span className="text-muted-foreground">
						{t("tools.password_manager.import.skipped_duplicates")}
					</span>
					<span className="font-semibold text-muted-foreground">
						{skipped} {t("tools.password_manager.import.items")}
					</span>
				</div>
			</div>
			...
			<div className="flex items-center gap-2 text-xs text-muted-foreground bg-primary/5 px-4 py-2 rounded-lg">
				...
				<span>
					{t("tools.password_manager.import.local_processing")}
				</span>
			</div>
			...
			<div className="pt-4">
				...
				>
					{t("tools.password_manager.import.done")}
				</Button>
			</div>
		</div>
	);

    ...
    ({
        ...
        if (viewMode === "list") {
            return (
                ...
                >
                    <div
                        className={`group flex items-center justify-between gap-3 glass-card px-4 py-3 transition-all duration-200 hover:border-primary/40 hover:bg-card/80 ${expired
        ...
        return (
            ...
            >
                <Link
                    to={"/" + item.id}
                    className={`group flex flex-col h-full glass-card p-3 transition-all duration-200 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/40 hover:-translate-y-0.5 ${expired
                            ? "opacity-60 border-destructive/30"
                            : expiringSoon
                                ? "border-amber-500/30"
                                : ""

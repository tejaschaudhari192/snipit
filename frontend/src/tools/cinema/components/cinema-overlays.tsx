...
export const CinemaErrorOverlay = ({
	...
	const isSafeUrl = (url: string) =>
		/^https?:\/\//i.test(url) && !/^(javascript|data|vbscript):/i.test(url);

	return (
		<div className="absolute inset-0 z-35 flex flex-col gap-4 items-center justify-center bg-background/85 backdrop-blur-md p-6 text-center animate-in fade-in duration-200">
			...
			<div className="space-y-1.5 max-w-sm">
				<h3 className="text-md font-bold text-foreground tracking-wider">
			...
			{videoSrc &&
				...
				videoSrc !== "p2p://local-stream" && (
					<Button
						...
						variant="outline"
						size="sm"
						className="h-9 px-4 font-bold border-border text-foreground hover:bg-muted"
					>
...
export const CinemaP2pConnectingOverlay = ({
	...
	return (
		<div className="absolute inset-0 z-30 flex flex-col gap-4 items-center justify-center bg-background/80 backdrop-blur-md p-6 text-center">
...
export const CinemaHostDisconnectedOverlay = ({
	...
	return (
		<div className="absolute inset-0 z-30 flex flex-col gap-4 items-center justify-center bg-background/85 backdrop-blur-md p-6 text-center animate-in fade-in duration-200">

...
export const CinemaErrorOverlay = ({ videoError }: CinemaErrorOverlayProps) => {
	if (!videoError) return null;

	return (
		<div className="absolute inset-0 z-35 flex flex-col gap-4 items-center justify-center bg-black/85 backdrop-blur-md p-6 text-center">
			...
			<div className="space-y-1.5 max-w-sm">
				<h3 className="text-md font-bold text-white tracking-wider animate-bounce">

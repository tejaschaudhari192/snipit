...
export const EditorContent = ({
	...
	return (
		<div
			...
			className={`m-3 sm:m-5 border border-border/50 bg-background/60 backdrop-blur-xl overflow-hidden touch-none shadow-2xl relative z-20 ring-1 ring-white/5 flex flex-col ${isFullscreen ? "fixed inset-0 m-0 z-50 rounded-none h-screen" : "h-[60vh] rounded-2xl"}`}
		>
			{(contentType === "code" ||
				contentType === "text" ||
				contentType === "draw") && (

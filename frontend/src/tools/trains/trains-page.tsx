...
import { Train, FileText, Calendar, Radio } from "lucide-react";
...
const TrainsPage = () => {
	...
	const [activeTab, setActiveTab] = useState<"pnr" | "schedule" | "live">(
		"pnr",
	);
				...
				<div className="max-w-3xl mx-auto text-center relative z-10 w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
					<div className="flex flex-col items-center justify-center w-full">
						...
						<p className="text-xs sm:text-sm text-muted-foreground font-medium max-w-lg mx-auto leading-normal">
							Check live PNR status, train route schedules, and
							real-time train tracking
						</p>

						{/* Sub-navigation tabs */}
						<div className="flex items-center gap-2 mt-5 p-1 rounded-xl bg-muted/30 border border-border/40">
							<button
